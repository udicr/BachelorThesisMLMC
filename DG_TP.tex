...
\end{align}
 ...
 Sei $ N = \abs{\mathcal{T}} $ und $ \mathcal{T} = \{K_1,\dots,K_N \} $ geordnet. Dann lässt sich die Zellenbasis $ \{ \mu_i \}_{i=1}^{G\abs{\mathcal{T}}} \subset \mathcal{Q}_h $ gemäß dem Träger der Basisfunktion zu $ \{ \mu_{K_j,i} \}_{j = 1,\dots,N ; i = 1,\dots,G } $ ordnen.
...
\end{cases}\\
\end{align*}
mit $ \underline{M},\underline{A} \in \R^{NG\times NG} $ und $ b: \mathbb{T} \to \R^{NG} $
