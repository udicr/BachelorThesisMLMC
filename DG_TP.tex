...
Runge-Kutta DG verfahren für hyperbolische Probleme betrachteten Cockburn und Shu in einer 5 teiligen Serie von Arbeiten. Besonders zu nennen sind in unserem Kontext dabei \cite{cockburn1989tvb} und \cite{cockburn1990runge}.
...
%	 \end{figure}
%	 Das diskretisierte Problem $ T_h \rho_h = 0  $ heißt genau dann konsistent, wenn für eine analytische Lösung $ \rho^{\star} \in E $ gilt, dass $ \lim\limits_{h \to 0}\lVert \Phi_h(T)L_1\rho - L_2T\rho \rVert_{F_h} = 0 $.
...
%	 Für die Zeitdiskretisierung in Form der impliziten Mittelpunktsregel gilt als einstufige Gauß-Quadratur $ \lVert \Phi_h(T)L_1\rho - L_2T\rho \rVert_{F_h} = O(h^2)$, womit sie insbesondere konsistent ist. \\
%	 Auf eine nähergehende Konsistenzanalyse soll an dieser Stelle verzichtet werden
%	 
%	 
%	 
%	 
